  ...
  return (
    <Col md={4} lg={3} className="mb-5">
      <Card className="h-100">
        <div>
          <img src={standar} alt="Suite Standar" className="w-100" />
        </div>
        <Card.Body>
          ...
          <Card.Text>
            ...
            aquellos que buscan un ambiente minimalista y funcional. Con líneas
            limpias y una paleta de colores neutros, esta habitación crea un
            espacio tranquilo y acogedor. Disfruta de un sueño reparador en
            nuestra cama de última generación y relájate en el cómodo sofá.
          </Card.Text>
        </Card.Body>
